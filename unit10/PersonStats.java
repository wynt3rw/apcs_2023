...
public class PersonStats {
    ...
    public static void testAveragePets(ArrayList<Person> personList, double expected) {
    ...
    public static void testMostPets(ArrayList<Person> personList, String expected) {
    ...
    public static void testTwoPets(ArrayList<Person> personList, ArrayList<Person> expected) {
    ...
    public static void main(String[] args) {
        ...
        expected.add(new Person("Scarlett", 3));
